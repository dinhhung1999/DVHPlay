...
import com.example.dvhplay.databinding.*;
...
public class TvSerieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_tv_serie, container, false);
        class DoGetVideo extends AsyncTask<Void, Void, Void> {
            ...
            public void getJsonArray(String json) {
                try {
                    ...
                    binding.rvTvSerie.setLayoutManager(GridlayoutManager);
                    binding.rvTvSerie.setAdapter(adapterVideo);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
